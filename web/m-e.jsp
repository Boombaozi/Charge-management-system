...
<div class="row">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<!--表格头部-->
				<div class="pull-left">
					<button class="btn btn-success glyphicon glyphicon-plus" data-toggle="modal" data-target="#add2">New</button>
					<button class="btn btn-primary glyphicon glyphicon-upload"data-toggle="modal" data-target="#updata2">update</button>
					<button class="btn btn-danger glyphicon glyphicon-trash"data-toggle="modal" data-target="#delete2">Delete</button>
				</div>
			</div>
		...
		<!--添加功能弹出狂主体-->
		<div class="modal fade" id="add2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<!--更新功能弹出狂主体-->
		<div class="modal fade" id="updata2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
