...
<div class="row">
		...
		<div class="row">
			...
			<form role="form" class=" col-xs-4 col-md-4 col-lg-4"action="${pageContext.request.contextPath }/web/etypeadd" method="post">

				<div class="form-group">
					<input class="form-control" placeholder="客户号" name="cno" type="text" >
				</div>
				<div class="form-group">
					<input class="form-control" placeholder="缴费金额" name="money" type="text" >
				</div>
