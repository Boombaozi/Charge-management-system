...
<head>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="#"><span class="glyphicon glyphicon-pencil"></span> 收费登记</a></li>
...
%>
        ...
        <div class="row">
            ...
            <form role="form" class=" col-xs-4 col-md-4 col-lg-4"
                  action="${pageContext.request.contextPath }/web/mainsettle" method="post">
                ...
                <div class="form-group">
                    <input class="form-control" placeholder="所结算的日期" name="date" type="text">
                </div>
                <input type="submit" class="btn btn-primary" value="系统结算">
            ...
            <form role="form" class=" col-xs-4 col-md-4 col-lg-4 "
                  action="${pageContext.request.contextPath }/web/mainpay1" method="post">

                <div class="form-group">
                    <input class="form-control" placeholder="客户号" name="cno" type="text">
                </div>
                <div class="form-group">
                    <input class="form-control" placeholder="缴费金额" name="ac" type="text">
                </div>
                <div class="form-group">
                    <input class="form-control" placeholder="操作员" name="eno" type="text">
                </div>
                <input type="submit" class="btn btn-primary" value="缴费">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <!--表格头部-->
                <div class="pull-left">
                    <button class="btn btn-success glyphicon glyphicon-plus" data-toggle="modal" data-target="#add4">
                        New
                    </button>

                    <button class="btn btn-danger glyphicon glyphicon-trash" data-toggle="modal" data-target="#delete4">
                        Delete
                    </button>
                </div>
            </div>
        ...
        <!--添加功能弹出狂主体-->
        <div class="modal fade" id="add4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    ...
                    <div class="modal-body">
                        <div class="login-panel panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" action="${pageContext.request.contextPath }/web/cradd"
                                      method="post">
                                        ...
                                        <div class="form-group">
                                            <input class="form-control" placeholder="应收" name="sc" type="text">
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" placeholder="实收" name="ac" type="text">
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" placeholder="业务员" name="eno" type="text">
                                        </div>
        ...
        <!--删除功能弹出狂主体-->
        <div class="modal fade" id="delete4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="login-panel panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" action="${pageContext.request.contextPath }/web/crdelete"
                                      method="post">
                                    <fieldset>
                                        <div class="form-group">
                                            <input class="form-control" placeholder="客户号" name="cno" type="text">
