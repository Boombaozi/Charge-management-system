...
<body>
 ...
 <!--这是菜单列表-->       
		<ul class="nav menu">
         ...
         <li ><a href="index.jsp"><span class="glyphicon glyphicon-list-alt"></span> 系统信息状态</a></li> 
   
   <li class="active"><a href="1.jsp"><span class="glyphicon glyphicon-list-alt"></span> 客户信息管理</a></li>              <li ><a href="my.jsp"><span class="glyphicon glyphicon-list-alt"></span> 测试页面</a></li>  
